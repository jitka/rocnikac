...
% Toto makro slouží k poznámkám, text se zobrazi červeně
...
\TODO{
a~ A ref cite !! i na konci radku\\
isn't\\
commintnout zdrojak\\
todo ve zdrojaku\\
napsat tomovy ze chci zapocet\\
\\Dotazy:\\
child v pseudokodu\\
vsechny theoremy maji stejne cislo\\
tabulky do ramecku a do seznamu tabulek\\
seznam obrazku\\
jak se sazi pseudokod? pokud mozno podobne jako \fce{}, pokud mozno bez Table\\
