...
% TODO
% mozna kapitola paralelizace, nefunguje predpocitani tah, spolecna cache, postupny update
...
% Toto makro slouží k poznámkám, text se zobrazi červeně TODO
\def\TODO#1{
\textcolor{red}{#1}
}
...
signature of the author \TODO{ Tady prijde jen rucni nebo i vytiskly podpis? }
\hss}}
...
RNDr. Tomáš Valla, Informatický ústav Univerzity Karlovy \TODO{je to pracoviste dobře?}
% Jméno a příjmení s tituly, pracoviště
% dle Organizační struktury MFF UK, případně plný název pracoviště mimo MFF UK

Abstrakt:
% abstrakt v rozsahu 80-200 slov; nejedná se však o opis zadání bakalářské práce
\TODO{TODO + zkontrolovat jestli sedi s anglictinou}

Klíčová slova:
% 3 až 5 klíčových slov
\TODO{TODO PN-search, silné poziční hry, kliková hra, vysoká hra, vylepšení PN-searche}
